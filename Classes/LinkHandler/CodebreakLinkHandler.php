...
namespace Passionweb\CustomLinkHandler\LinkHandler;
...
class CodebreakLinkHandler extends AbstractLinkHandler implements LinkHandlerInterface, LinkParameterProviderInterface
{
    ...
    public function formatCurrentUrl(): string
    {
        ...
        if ($pageRecord === false) {
            return $lang->sL('LLL:EXT:custom_link_handler/Resources/Private/Language/locallang.xlf:page') . ' ' . $idInfo;
        }

        $pageTitle = $pageRecord['title'] ?? '';
        return $lang->sL('LLL:EXT:custom_link_handler/Resources/Private/Language/locallang.xlf:page')
            ...
            $fieldDefinitions['pageIdSelector'] = '
				<form><div class="row mt-3">
					<label class="col-3 col-form-label">
						' . htmlspecialchars($this->getLanguageService()->sL('LLL:EXT:backend/Resources/Private/Language/locallang.xlf:page_id')) . '
						</label>
					<div class="col-2">
						<input type="number" size="6" name="luid" id="luid" class="form-control" />
					</div>
					<div class="col-7">
						<input class="btn btn-default t3js-pageLink" type="submit" value="' . htmlspecialchars($this->getLanguageService()->sL('LLL:EXT:backend/Resources/Private/Language/locallang.xlf:setLink')) . '" />
					</div>
				</div></form>';
        }
